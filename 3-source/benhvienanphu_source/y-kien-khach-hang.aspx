<%@ Page Title="" Language="C#" MasterPageFile="~/site-sub.master" AutoEventWireup="true" CodeFile="y-kien-khach-hang.aspx.cs" Inherits="y_kien_khach_hang" %>
                ...
                <ItemTemplate>
                    <div class="post-box">
                        ...
                        <div class="post-content">
                            <div class="post-name"><a href="javascript:void(0);"><%# Eval("ProjectTitle") %></a></div>
                            <div class="description mCustomScrollbar content"><%# Eval("Content") %></div>
                        </div>
                    </div>
                </ItemTemplate>
                <LayoutTemplate>
