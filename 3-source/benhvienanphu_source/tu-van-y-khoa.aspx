<%@ Page Title="" Language="C#" MasterPageFile="~/site-sub.master" AutoEventWireup="true" CodeFile="tu-van-y-khoa.aspx.cs" Inherits="tu_van_y_khoa" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="colmain" runat="Server">
    ...
    <div class="news-main">
        <asp:ListView ID="lstTuVan" runat="server" DataSourceID="odsTuVan"
        ...
        <asp:ObjectDataSource ID="odsTuVan" runat="server" SelectMethod="ProjectSelectAll" TypeName="TLLib.Project">
            <SelectParameters>
                <asp:Parameter Name="StartRowIndex" Type="String" />
                <asp:Parameter Name="EndRowIndex" Type="String" />
    ...
    <div class="pager">
        <asp:DataPager ID="DataPager1" runat="server" PageSize="5" PagedControlID="lstTuVan">
            <Fields>
