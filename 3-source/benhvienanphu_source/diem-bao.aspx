<%@ Page Title="" Language="C#" MasterPageFile="~/site-sub.master" AutoEventWireup="true" CodeFile="diem-bao.aspx.cs" Inherits="diem_bao" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="colmain" runat="Server">
    ...
    <div class="news-main">
        <asp:ListView ID="lstDiemBao" runat="server" DataSourceID="odsDiemBao"
            ...
            <ItemTemplate>
                <div class="news-box">
                    ...
                    <div class="news-content">
                        <div class="news-name"><a href='<%# progressTitle(Eval("ProjectTitle")) + "-tt-" + Eval("ProjectID") + ".aspx" %>'><%# Eval("ProjectTitle") %></a></div>
        ...
        <asp:ObjectDataSource ID="odsDiemBao" runat="server" SelectMethod="ProjectSelectAll" TypeName="TLLib.Project">
            <SelectParameters>
                <asp:Parameter Name="StartRowIndex" Type="String" />
                <asp:Parameter Name="EndRowIndex" Type="String" />
                ...
                <asp:Parameter DefaultValue="8" Name="ProjectCategoryID" Type="String" />
    ...
    <div class="pager">
        <asp:DataPager ID="DataPager1" runat="server" PageSize="5" PagedControlID="lstDiemBao">
            <Fields>
