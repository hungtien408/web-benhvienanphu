<%@ Page Title="" Language="C#" MasterPageFile="~/site-sub.master" AutoEventWireup="true" CodeFile="bai-viet-y-khoa.aspx.cs" Inherits="bai_viet_y_khoa" %>
                ...
                <div class="list-posts">
                    <asp:ListView ID="lstArticleMedical" runat="server" DataSourceID="odsArticleMedical"
                        ...
                        <ItemTemplate>
                            <div class="post-box">
                                <div class="post-img">
                                    <a href='<%# progressTitle(Eval("ProjectTitle")) + "-bv-" + Eval("ProjectID") + ".aspx" %>'>
                                        <img alt='<%# Eval("ImageName") %>' src='<%# "~/res/project/" + Eval("ImageName") %>'
                                            visible='<%# string.IsNullOrEmpty( Eval("ImageName").ToString()) ? false : true %>'
                                            runat="server" /></a>
                                </div>
                                <div class="post-content">
                                    <div class="post-name"><a href='<%# progressTitle(Eval("ProjectTitle")) + "-bv-" + Eval("ProjectID") + ".aspx" %>'><%# Eval("ProjectTitle") %></a></div>
