<%@ Page Title="" Language="C#" MasterPageFile="~/en/site-sub.master" AutoEventWireup="true" CodeFile="he-thong-phong-kham.aspx.cs" Inherits="he_thong_phong_kham" %>
                    ...
                    <div class="system-box">
                        ...
                        <div class="system-content">
                            <div class="address-system">
                                <h2><%# Eval("ProjectTitleEn") %></h2>
                                <p><span class="fa fa-map-marker"></span>Địa chỉ: <%# Eval("TagEn") %></p>
                                <p><span class="fa fa-phone"></span>Điện thoại: <%# Eval("MetaTittleEn") %></p>
                                <p><span class="fa fa-fax"></span>Fax: <%# Eval("MetaDescriptionEn") %></p>
                                <p><span class="fa fa-envelope"></span>Email:<a href='<%# "mailto:" + Eval("DescriptionEn") %>'><%# Eval("DescriptionEn") %></a></p>
                                ...
                                <div id="login-modal1" class="modal modal-system" style="display: none;">
                                    <div class="modaltitle"><%# Eval("ProjectTitleEn") %></div>
                                    <div class="map-ifram">
                                        <%# Eval("ContentEn") %>
                                    </div>
                                </div>
