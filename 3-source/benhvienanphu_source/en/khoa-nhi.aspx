<%@ Page Title="" Language="C#" MasterPageFile="~/en/site-sub.master" AutoEventWireup="true" CodeFile="khoa-nhi.aspx.cs" Inherits="khoa_nhi" %>

<%@ Register Src="~/en/uc/list-khoa.ascx" TagPrefix="uc1" TagName="listkhoa" %>
