...
public partial class uc_dat_lich : System.Web.UI.UserControl
{
    ...
    private void sendEmail()
    {
        ...
        string msg = "<h3 style='font-size: 18px'>BỆNH VIỆN AN PHÚ: ĐẶT LỊCH KHÁM</h3><br/>";
        ...
        TLLib.Common.SendMail("smtp.gmail.com", 587, "webmastersendmail0401@gmail.com", "web123master", "hungtien408@gmail.com", "", "ĐẶT LỊCH KHÁM BỆNH VIỆN AN PHÚ", msg, true);
    }
    protected void btnDatLich_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterClientScriptBlock(Page, Page.GetType(), "runtime", " $(document).ready(function () {$('.buttongui a').trigger('click');});", true);
        }
    }
}