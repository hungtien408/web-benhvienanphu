<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="articlemedical.aspx.cs" Inherits="ad_single_project" %>
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Bài Viết Y Khoa</h3>
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td runat="server">
                                        ...
                                        <span class="required">(Kích thước 130px x 110px)</span>
                                    </td>
                                </tr>
                                <tr>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProjectSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchDescription" Name="Description" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter ControlID="ddlSearchCategory" DefaultValue="18" Name="ProjectCategoryID" PropertyName="SelectedValue"
                Type="String" />
