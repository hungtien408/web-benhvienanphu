<%@ Page Title="" Language="C#" MasterPageFile="~/site-sub.master" AutoEventWireup="true" CodeFile="thong-tin-bac-si.aspx.cs" Inherits="thong_tin_bac_si" %>
            ...
            <div class="select-id">
                <select id="selectNav" name="cd-dropdown" class="cd-select">
                    <asp:ListView ID="lstPhongBan" runat="server" DataSourceID="odsPhongBan"
                        EnableModelValidation="True">
                        <ItemTemplate>
                            <option value='<%# Container.DataItemIndex + 1 %>'><%# Eval("ProjectCategoryName") %></option>
                        </ItemTemplate>
                        <LayoutTemplate>
                            <span runat="server" id="itemPlaceholder" />
                        </LayoutTemplate>
